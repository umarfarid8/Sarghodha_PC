...
class Add_Assumption_HoldActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonupdate.setOnClickListener(){
            ...
            materialData.moistureAssumptionL = binding.etMoistureAssumptionL.text.toString().toFloatOrNull()

            materialData.sandHoldL = binding.etSandHoldL.text.toString().toFloatOrNull()
            materialData.sandAssumptionL = binding.etSandAssumptionL.text.toString().toFloatOrNull()

            materialData.mudPieceHoldL = binding.etMudPieceHoldL.text.toString().toFloatOrNull()
            materialData.mudPieceAssumptionL = binding.etMudPieceAssumptionL.text.toString().toFloatOrNull()

            materialData.burraysHoldL = binding.etBurraysHoldL.text.toString().toFloatOrNull()
            materialData.burraysAssumptionL = binding.etBurraysAssumptionL.text.toString().toFloatOrNull()

            materialData.finesHoldL = binding.etFinesHoldL.text.toString().toFloatOrNull()
            materialData.finesAssumptionL = binding.etFinesAssumptionL.text.toString().toFloatOrNull()
        ...
        lifecycleScope.launch {
            viewModel.isSaved.collect{
                if (it){
                    progressDialog.show()
                    Toast.makeText(this@Add_Assumption_HoldActivity, "Updated/Added Successfully", Toast.LENGTH_SHORT).show()
                    startActivity(Intent(this@Add_Assumption_HoldActivity, MainActivity::class.java))
                    finish()
                }
            }
        }
        ...
        lifecycleScope.launch {
            viewModel.isEmtpy.collect{
                if (it) {
                    ...
                    Toast.makeText(this@Add_Assumption_HoldActivity, "No Existing Data Found", Toast.LENGTH_SHORT
                    ).show()
    ...
    fun updateInformation(material:Material){
        binding.etMoistureAssumptionL.setText(material.moistureAssumptionL.toString())
        binding.etMoistureHoldL.setText(material.moistureHoldL.toString())

        binding.etSandAssumptionL.setText(material.sandAssumptionL.toString())
        binding.etSandHoldL.setText(material.sandHoldL.toString())

        binding.etMudPieceAssumptionL.setText(material.mudPieceAssumptionL.toString())
        binding.etMudPieceHoldL.setText(material.mudPieceHoldL.toString())

        if( material.material != "Brassica Straw Loose" ){

            binding.etBurraysAssumptionL.setText(material.burraysAssumptionL.toString())
            binding.etBurraysHoldL.setText(material.burraysHoldL.toString())

            binding.etFinesAssumptionL.setText(material.finesAssumptionL.toString())
