...
class HistoryQualityAdapter(val items: ArrayList<Load>) : RecyclerView.Adapter<HistoryQualityViewHolder>() {

    // Use sizes as a mutable list to hold the data for the adapter
    private var sizes: List<Load> = items

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): HistoryQualityViewHolder {

        return HistoryQualityViewHolder(
            ItemQualityHistoryBinding.inflate(
    ...
    override fun onBindViewHolder(holder: HistoryQualityViewHolder, position: Int) {
